...
**Copyright (c) 2026 Nas Frost**

## 1. Website Source Code
The **source code** of this website (including but not limited to HTML, CSS, and Python files) is distributed under the terms of the **Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License (CC BY-NC-SA 4.0)**.
...
* Brief quotations for the purpose of critical reviews or certain other non-commercial uses permitted by copyright law are allowed.